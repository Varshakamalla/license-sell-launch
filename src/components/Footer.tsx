...
const Footer = () => {
  ...
  return (
    <footer className="bg-softsell-dark text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              SoftSell is the leading marketplace for businesses to buy and sell unused software licenses, 
              helping organizations recover costs and optimize their software investments.
            </p>
